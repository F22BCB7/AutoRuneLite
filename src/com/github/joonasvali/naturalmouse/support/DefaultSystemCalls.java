...
public class DefaultSystemCalls implements SystemCalls {
  ...
  public void setMousePosition(int x, int y) {
    //robot.mouseMove(x, y);
	  Data.inputManager.getMouseListener().sendEvent(new MouseEvent((Component)Data.clientInstance, MouseEvent.MOUSE_MOVED, System.currentTimeMillis(), 0, x, y, 0, false, 0));
  }
}
